    ...
    <div>
                            ...
                            <div class="modal__content p-10 text-center">
                                ...
                                <form class=" p-6 rounded-md shadow-md w-full max-w-sm text-left"
                                    ...
                                    <div class="flex justify-between items-center border-b pb-3">
                                        <h3 class="text-xl font-semibold text-gray-700">Add Kategori
                                        </h3>
                                    </div>
                                    ...
                                    <div class="mt-3 mb-4">
                                        ...
                                        <input type="text" id="barcode" name="barcode"
                                            class="input w-full border mt-2" placeholder="Barcode" autofocus>
                                        @error('barcode')
                                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                                        @enderror
                                    </div>
        ...
        <script>
            document.getElementById('search-produk').addEventListener('keyup', function() {
                ...
                fetch(`/produk/search?keyword=${keyword}`)
                    ...
                    .then(produks => {
                        ...
                        <tr class="intro-x">
                            ...
                            <td class="text">${produk.kategori}</td>
                            <td class="text-center">${produk.barcode}</td>
                        ...
                        button.addEventListener('click', function() {
                            ...
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    ...
                                    form.method = 'POST';
                                    form.action =
                                        `/produk/${id}`; // Pastikan URL untuk delete sesuai
